package com.example.app.Printer.adapter;
...
public class USBAdapter {
    ...
    public void createConn(Context context) {
        ...
        final String ACTION_USB_PERMISSION = "com.example.app.Printer.usbprinter.USB_PERMISSION";
    ...
    private static final String ACTION_USB_PERMISSION =
            "com.example.app.Printer.usbprinter.USB_PERMISSION";
    private final BroadcastReceiver mUsbReceiver = new BroadcastReceiver() {

        public void onReceive(Context context, Intent intent) {
            Log.i(TAG, "usb printer broadcast onreceive");
